        ...
        if not all(spalte in df.columns for spalte in erforderliche_spalten):
            ...
            if st.button("🚀 Top 10 Kombinationen berechnen"):
                ...
                for v_idx in range(1, anzahl_varianten + 1):
                    status_text.text(f"Berechne Variante {v_idx} von 10... (Max. 15 Sek. pro Variante)")
                    ...
                    # Auf 15 Sekunden Zeitlimit erhöht, um die Treffsicherheit bei 60+ Zeilen zu steigern
                ...
                if len(gefundene_varianten) == 0:
                    ...
                    st.download_button(
                        ...
                        file_name="4d_optimierung_top10_stabil.xlsx",
                        mime="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                    )
