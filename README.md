...
Die Datei `index.html` verarbeitet Excel-Dateien und berechnet die Varianten vollständig im Browser. Es werden keine Nutzdaten an einen Server übertragen. Beim Öffnen werden lediglich die JavaScript-Bibliotheken SheetJS und GLPK.js über ein CDN geladen.
